...
model = Sequential()
model.add(Conv1D(128, 50, activation='relu', input_shape=(check, 1)))
...
hist = model.fit(X_train, Y_train, validation_data=(X_val, Y_val), batch_size=256, epochs=450, verbose=2, shuffle=True, callbacks=[checkpointer])
